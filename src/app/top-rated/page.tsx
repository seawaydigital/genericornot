...
export const metadata: Metadata = {
  title: "Top Rated Comparisons — GenericOrNot",
  description:
    "The highest-confidence generic vs name-brand comparisons on GenericOrNot, ranked by community votes and agreement.",
};
...
export default async function TopRatedPage() {
  const comparisons = await getTopRated();
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="mt-2 text-gray-500 text-sm">
            The most trusted comparisons, ranked by confidence score and community consensus.
          </p>
        </div>
